...
1. Sum
    ...
    sum = nums.reduce((accumalator, currentValue) => {
...
const discountProducts = products.map(x => x.price = x.price/2);
...
const cheapProducts = products.filter(x => x.price < 70);
